...
Turn an open-ended question into a structured, well-cited research report. Gather information from multiple sources, weigh their credibility, synthesize findings across viewpoints, and surface both consensus and open debate — never a single-source answer dressed up as fact.
...
- **Deliverable:** a sharp, scoped question and stated purpose.

### Phase 2 — Identify Key Aspects
- Break the topic into subtopics or dimensions
- List the main questions to answer
- Note important context or background needed
- **Deliverable:** a list of subtopics and the questions each must answer.

### Phase 3 — Gather Information
- Consider multiple perspectives
- Look for primary and secondary sources
- Check publication dates and currency
- Evaluate source credibility (see [Source Evaluation](#source-evaluation))
- **Deliverable:** a pool of vetted sources mapped to subtopics.
...
- **Deliverable:** synthesized findings with consensus vs. debate separated.

### Phase 5 — Document Sources
...
- **Deliverable:** a citation list, each entry with a credibility note.
...
When citing sources, note credibility:
