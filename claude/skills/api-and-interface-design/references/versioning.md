...

{
  ...
  "status": 410,
  "detail": "API v1 was sunset on 2025-01-15. Migrate to v2.",
  "instance": "/requests/req-abc123",
  "documentationUrl": "https://api.example.com/docs/migration-v1-to-v2"
}
```

410 rather than 404: it tells the client the endpoint is gone deliberately and permanently, so retry logic stops instead of treating it as a transient miss.
...
Response:
{
  "versions": {
    "v1": {
      ...
      "documentationUrl": "https://api.example.com/docs/v1"
    },
    "v2": {
      "status": "current",
    ...
    "v3": {
      "status": "beta",
      "documentationUrl": "https://api.example.com/docs/v3"
    }
  }
}
```
