...
> **High-impact changes** (API, auth, DB, security): read `references/pr-template.md` and use the expanded format instead.
...
- <What changed and why — group by concern if there are many, clear bullet-point list of the modifications>
- ...
