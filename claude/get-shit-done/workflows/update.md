...
if [ -f "./.claude/get-shit-done/VERSION" ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/bennycheng/.claude/get-shit-done/VERSION ]; then
  cat /Users/bennycheng/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/bennycheng/.claude/` for global, `./.claude/` for local)
